...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "annu_updates")
    TEMP_DOWNLOAD_DIRECTORY = os.environ.get("annu_updates", "./")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "8857291657").split())
    except ValueError:
